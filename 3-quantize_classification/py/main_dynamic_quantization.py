...
if __name__ == '__main__':
    ...
    saved_weight = 'weight/AnimeFace_mobilenetv2_dynamic_quantization_epoch100.pth'
    torch.save(quantized_model.state_dict(), saved_weight)
    saved_script = 'weight/AnimeFace_mobilenetv2_script_dynamic_quantization_epoch100.pth'
