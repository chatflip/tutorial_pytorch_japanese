...
def opt():
    ...
    parser.add_argument('--voc_root', type=str, default='./../datasets/VOCdevkit/VOC2012')
...
def main(args):
    ...
    image_list_path = os.path.join(args.voc_root, "ImageSets", "Segmentation", "trainval.txt")
